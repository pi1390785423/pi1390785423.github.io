function setTime() {
    window.onload = function () {
      window.sessionStorage.getItem('time',date123);
      ...
      .querySelectorAll("span");
         // window.sessionStorage.setItem('Class','兰青'
         var date121=new Date(3700);
         var date123= date121.setTime(date121.getTime()+30*60);
         console.log(date123);
         console.log(date121);
 ...
 window.sessionStorage.setItem('time',date123)
